...
// Compare two revisions of an issue
router.post('/issues/:id/revisions/compare',
  middleware.auth,
  validations.middleware(validations.schemas.revisions.compare),
  issuesController.compareRevisions
);
